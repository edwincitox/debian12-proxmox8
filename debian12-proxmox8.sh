...
# Contact: niwde.2580@gmail.com
################################################################################
#
# Script updates can be found at: https://github.com/edwincitox/debian12-proxmox8
#
...
################################################################################
#
# Assumptions: Debian12 installed with a valid FQDN hostname set
#
...
#
# Note: will automatically run the proxmox-post-install.sh script
#
# Thanks to eXtremeSHOK.com
#
# Usage:
# curl -O https://raw.githubusercontent.com/edwincitox/debian12-proxmox8/main/debian12-proxmox8.sh && chmod +x debian12-proxmox8.sh && ./debian12-proxmox8.sh && rm debian12-proxmox8.sh
#
#
################################################################################
#
...
echo "Remove legacy (4) kernel"
/usr/bin/env DEBIAN_FRONTEND=noninteractive apt-get -y -o Dpkg::Options::='--force-confdef' remove linux-image-amd64 linux-image-4*

echo "Remove legacy (5) kernel"
/usr/bin/env DEBIAN_FRONTEND=noninteractive apt-get -y -o Dpkg::Options::='--force-confdef' remove linux-image-amd64 linux-image-5*

echo "Remove legacy (6) kernel"
